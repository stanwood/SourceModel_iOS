...
class ModelCollectionTest: XCTestCase {
    ...
    func testCount() {
        let count = 16
        XCTAssertEqual(modelCollection.numberOfItems, count)
    }
    
    func testInsert() {
        let object = Item(title: "Test", subTitle: "Item", signature: "Aaron", value: "Is Great")
        let objects = self.modelCollection!
    ...
    func testIndex() {
        ...
        let index = modelCollection.index(of: objectThree)
    ...
    func testDataPersistence() {
        do {
            ...
            if let loadedDeals = loadedDeals {
                XCTAssertEqual(modelCollection.numberOfItems, loadedDeals.numberOfItems)
                
                let object = Item(title: "Test", subTitle: "Item", signature: "Aaron", value: "Most Handsome Man?")
                loadedDeals.append(object)
                
                XCTAssertNotEqual(modelCollection.numberOfItems, loadedDeals.numberOfItems)
